...
=== "Groovy"
    ...
    - 新版本
        ...
        plugins {
            ...
            id "io.github.FlyJingFish.AndroidAop.android-aop" version "2.5.4" apply true
        }
        ```
    ...
    - 或者老版本
        ...
        buildscript {
          dependencies {
              //👇必须项 (1)👈
              classpath "io.github.FlyJingFish.AndroidAop:android-aop-plugin:2.5.4"
          }
        }
...
=== "Groovy"
    ...
    plugins {
        ...
        id "io.github.FlyJingFish.AndroidAop.android-aop" version "2.5.4"//最好放在最后一行
    }
    ```
...
=== "Groovy"
    ...
    dependencies {
        //👇必须项 
        implementation "io.github.FlyJingFish.AndroidAop:android-aop-core:2.5.4"
        //👇非必须项 (1)👈 这个包提供了一些常见的注解切面
        implementation "io.github.FlyJingFish.AndroidAop:android-aop-extra:2.5.4" 
        
        //👇必须项 如果您项目内已经有了这项不用加也可以
        implementation "androidx.appcompat:appcompat:1.3.0" // 至少在1.3.0及以上
        
        //👇非必须项 (2)👈点击+查看详细说明，⚠️支持Java和Kotlin代码写的切面
        ksp "io.github.FlyJingFish.AndroidAop:android-aop-ksp:2.5.4"
        
        //👇非必须项 (3)👈点击+查看详细说明，⚠️只适用于Java代码写的切面
        annotationProcessor "io.github.FlyJingFish.AndroidAop:android-aop-processor:2.5.4"
