...
按照上述[步骤一的方式一配置项目](#1-introduce-the-plug-in-choose-one-of-the-two-methods-below-required)，就可以了。**这个方式自动为所有的 module 应用 debugMode**


**方式二：**

请按照上述[步骤一的方式一配置项目](#1-introduce-the-plug-in-choose-one-of-the-two-methods-below-required)后，手动为**所有子 module 模块**设置，例如：
