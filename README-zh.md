...
- 新版本
  ...
  plugins {
      ...
      id "io.github.flyjingfish.androidaop" version "2.6.7" apply true
  }
  ```
  <details>
  ...
  ```gradle
    buildscript {
        dependencies {
            //必须项 👇
            classpath 'io.github.flyjingfish:androidaop-plugin:2.6.7'
        }
    }
...
- 直接在 **app** 的 ```build.gradle``` 添加
  ...
  plugins {
      ...
      id "io.github.flyjingfish.androidaop" version "2.6.7"//最好放在最后一行
  }
  ```
...
dependencies {
    //必须项 👇
    implementation 'io.github.flyjingfish:androidaop-core:2.6.7'
    //非必须项 👇这个包提供了一些常见的注解切面
    implementation 'io.github.flyjingfish:androidaop-extra:2.6.7'
